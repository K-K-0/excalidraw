import { Download, Github, Link, Pencil, Share2, Sparkles, Users2 } from "lucide-react";
        ...
        <section className="py-24 bg-muted/50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-3">
              <Card className="p-6 border-2 hover:border-primary transition-colors" title="Real-time Collaboration" href="#">
